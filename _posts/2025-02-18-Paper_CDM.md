...
**위 식은 로봇이 받는 힘과 각 관절 힘, 토크 및 베이스에 걸리는 힘, 토크 사이의 관계**입니다. 위 식에서의 $\mathcal{W}$는 **DOB(Momentum Based Disturbance Observer)**나 **EDOB(Extended DOB)**를 통해 그 예측값을 얻을 수 있습니다.
