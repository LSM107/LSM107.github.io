...
$$
명세된 수식이 다소 복잡해 보이지만, 대각선 제약조건을 정확하게 표현되어 있습니다.



명세를 축약된 표현으로 나타내서 몇개 안돼 보이지만, 사실 8-queens 문제의 축약된 명세를 나열하면 요구사항의 개수가 740개나 됩니다! 이렇게 요구사항이 꽤 많은데도, SMT 솔버 도구를 사용해보면 해를 굉장히 빠른 시간 안에 찾아내는 것을 확인할 수 있습니다. 
