...
$\epsilon$​의 크기가 변화함에 따라 분류를 잘 수행하는 모델이 변화할 수 있습니다. 이 논문에서는 각 구간에서 가장 잘하는 모델로 교체함으로써 정확도를 향상시킬 수 있다고 주장합니다.
...
위의 수식들은 Haze encoding에 대한 formal verification의 constraints입니다. 다른 종류의 Contextual Perturbation에 대한 formal verfication을 수행하기 위해선, (7)의 constraint를 검증하고자 하는 Contextual Perturbation을 표현하는 수식으로 교체해야 합니다. constraints의 satisfiability는 MILP-solver 혹은  Reluplex procedure를 통해 확인할 수 있습니다.
...
![output](/images/2024-02-15-DeepCert/output.png)

GTSRB는 교통 표지판 인식 알고리즘의 성능을 평가하는 데 사용되는 벤치마크입니다. 총 43개의 클래스로 구성되어 있고, 다양한 조명 조건과 배경에서 촬영된 이미지를 제공합니다. 



<img src="/images/2024-02-15-DeepCert/output-1.png" alt="output-1" style="zoom: 33%;" />
...
![스크린샷 2024-02-17 오후 11.22.13](/images/2024-02-15-DeepCert/스크린샷 2024-02-17 오후 11.22.13.png)
...
![스크린샷 2024-02-17 오후 11.24.27](/images/2024-02-15-DeepCert/스크린샷 2024-02-17 오후 11.24.27.png)
...
![image-20240217233252364](/images/2024-02-15-DeepCert/image-20240217233252364.png)
...
![image-20240217233723770](/images/2024-02-15-DeepCert/image-20240217233723770.png)
...
![image-20240217234839822](/images/2024-02-15-DeepCert/image-20240217234839822.png)
...
![image-20240217235249349](/images/2024-02-15-DeepCert/image-20240217235249349.png)
...
Contextual-perturbation은 non-contextual point perturbation와 비교했을 때, perturbation이 더 크게 가해집니다. 사람조차 알아볼 수 없을만큼 perturbation이 가해진 이미지를 올바른 클래스로 분류할 수 있는지를 통해 신경망의 robustness를 판단하는 것은 올바른 기준이 아닐 수 있습니다. contextual perturbation이 가해진 이미지가 클래스 도메인을 벗어나는지 확인할 필요가 있어 보입니다.



#### 글을 끝마치며..

contextual robustness에 대해 쉽게 배울 수 있는 논문인 것 같습니다. 내용이 크게 복잡하지 않아서, 이 분야를 처음 접하시는 분들도 어렵지 않게 읽으실 수 있을 것 같습니다.
