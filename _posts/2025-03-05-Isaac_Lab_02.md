...
이 코드를 실행시켜보면, 장면이 짧은 시간 간격을 두고 4개의 초록색 원뿔이 약간의 무작위성이 더해진 위치에서 리셋됩니다. 그리고 리셋되기까지 일정한 시간 간격을 두고 총 4번의 시작 위치 정보를 가져옵니다. 어떻게 무작위성이 더해진 상태로 물체를 초기화시킬 수 있는지, 그리고 장면에 있는 프림들의 정보를 어떻게 가져오는지 아래에서 살펴봅니다.
...
## [관절 사용법](https://isaac-sim.github.io/IsaacLab/main/source/tutorials/01_assets/run_articulation.html)
